...
ALTER TABLE `inspire_main` ADD COLUMN `images` TEXT DEFAULT NULL COMMENT '多图JSON数组' AFTER `img`;
ALTER TABLE `inspire_main` ADD COLUMN `share_count` INT DEFAULT 0 COMMENT '分享数' AFTER `heat`;
