...
const routes = [
  ...
  { path: '/messages', name: 'Messages', component: Messages, meta: { needLogin: true, fixedViewport: true } },
  ...
  { path: '/admin/login', name: 'AdminLogin', component: AdminLogin, meta: { deviceShell: false } },
  {
    path: '/admin',
    component: AdminLayout,
    meta: { needAdmin: true, deviceShell: false },
    children: [
